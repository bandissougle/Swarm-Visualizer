...
<head>
  ...
  xhttp.open("GET", "http://192.168.19.147:5555/swarm", true);
  xhttp.send();
    }
  function getNetInfo() {
	...
	alert({domain: sock.getLocalAddress().getHostName(), ip: sock.getLocalAddress().getHostAddress()});
    }
  </script>
</head>
<header>
  <nav>
    <ul>
      ...
      <li><a>Join</a>
        <ul>
          <li><a href="#" onclick=""></a></li>
          <li><a href="#" onclick="eteindre()"></a></li>
          <li><a href="#" onclick=""></a></li>
        </ul>
      </li>
      <li><a>Leave</a>
        <ul>
          <li><a href="#" onclick=""></a></li>
          <li><a href="#" onclick=""></a href="#" onclick=""></li>
          <li><a href="#" onclick=""></a></li>
        </ul>
      </li>
      <li><a href="#" onclick="getNetInfo()">Information</a>
      </li>
    </ul>
  </nav>
</header>
